...
export type OfficialBoardSectionFragment = { __typename?: 'ComponentSectionsOfficialBoard', id: string };
...
type Sections_ComponentSectionsOfficialBoard_Fragment = { __typename: 'ComponentSectionsOfficialBoard', id: string };
...
export const OrganizationalStructureSectionFragmentDoc = gql`
  ...
  title
    ...
    `;
export const OfficialBoardSectionFragmentDoc = gql`
    fragment OfficialBoardSection on ComponentSectionsOfficialBoard {
  id
}
    `;
export const SectionsFragmentDoc = gql`
  ...
  ... on ComponentSectionsOfficialBoard {
...
${OfficialBoardSectionFragmentDoc}`;
