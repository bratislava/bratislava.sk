        ...
        sections?: Array<
          ...
          | {
              ...
              imageSrc?: {
                ...
                data?: {
                  __typename?: 'UploadFileEntity'
                  attributes?: { __typename?: 'UploadFile'; url: string; alternativeText?: string | null } | null
                } | null
              } | null
            }
          | {
  ...
  pageCategories?: {
    ...
    data: Array<{
      ...
      attributes?: {
        ...
        title?: string | null
        color?: Enum_Pagecategory_Color | null
        icon?: Enum_Pagecategory_Icon | null
        iconHover?: Enum_Pagecategory_Iconhover | null
        ...
        subcategories?: {
          ...
          data: Array<{
            ...
            attributes?: {
              ...
              title?: string | null
              priority?: number | null
              icon?: Enum_Pagesubcategory_Icon | null
              moreLink?: {
                __typename?: 'ComponentBlocksPageLink'
                title?: string | null
                url?: string | null
...
export type BlogPostsStaticPathsQuery = {
  ...
  blogPosts?: {
    ...
    data: Array<{
      __typename?: 'BlogPostEntity'
      id?: string | null
      attributes?: { __typename?: 'BlogPost'; slug?: string | null } | null
    }>
  } | null
}
...
export type LatestBlogsFragment = {
  __typename?: 'BlogPostEntityResponseCollection'
  data: Array<{
    __typename?: 'BlogPostEntity'
    id?: string | null
...
export type PageLinkFragment = {
  ...
  page?: {
    ...
    data?: {
      __typename?: 'PageEntity'
      attributes?: { __typename?: 'Page'; title?: string | null; slug?: string | null; locale?: string | null } | null
    } | null
  } | null
}
    ...
    data?: {
      ...
      attributes?: {
                ...
                data?: {
                  ...
                  attributes?: {
                    ...
                    pageCategory?: {
                      ...
                      data?: {
                        __typename?: 'PageCategoryEntity'
                        attributes?: { __typename?: 'PageCategory'; color?: Enum_Pagecategory_Color | null } | null
                      } | null
                    } | null
                  } | null
                } | null
        ...
        cards?: Array<{
          ...
          text?: string | null
          variant?: string | null
          link?: { __typename?: 'ComponentBlocksBookmarkLink'; title?: string | null; href?: string | null } | null
          picture?: {
            __typename?: 'UploadFileEntityResponse'
            data?: {
              __typename?: 'UploadFileEntity'
...
export type FlatTextFragment = {
  ...
  moreLinkPage?: {
    ...
    data?: {
      __typename?: 'PageEntity'
      attributes?: { __typename?: 'Page'; slug?: string | null; title?: string | null; locale?: string | null } | null
    } | null
  } | null
}
...
type Sections_ComponentSectionsListItems_Fragment = {
  ...
  listItems?: Array<{
    ...
    moreLinkPage?: {
      ...
      data?: {
        __typename?: 'PageEntity'
        attributes?: { __typename?: 'Page'; locale?: string | null; slug?: string | null; title?: string | null } | null
      } | null
    } | null
  } | null> | null
}
...
export const LatestBlogsWithTagsDocument = gql`
  query LatestBlogsWithTags(
    ...
    blogPosts(sort: $sort, pagination: { limit: $limit, start: $start }, filters: $filters, locale: $locale) {
      ...LatestBlogs
    }
  }
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    Footer(variables: FooterQueryVariables, requestHeaders?: Dom.RequestInit['headers']): Promise<FooterQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<FooterQuery>(FooterDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }),
        'Footer',
        'query'
      )
    },
    MainMenu(variables: MainMenuQueryVariables, requestHeaders?: Dom.RequestInit['headers']): Promise<MainMenuQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<MainMenuQuery>(MainMenuDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }),
        'MainMenu',
        'query'
      )
    },
    ...
    Homepage(variables: HomepageQueryVariables, requestHeaders?: Dom.RequestInit['headers']): Promise<HomepageQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<HomepageQuery>(HomepageDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }),
        'Homepage',
        'query'
      )
    },
    Pages(variables?: PagesQueryVariables, requestHeaders?: Dom.RequestInit['headers']): Promise<PagesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<PagesQuery>(PagesDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }),
        'Pages',
        'query'
      )
    },
    ...
    VznDetail(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<VznDetailQuery>(VznDetailDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }),
        'VznDetail',
        'query'
      )
    },
