...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    VznStaticPaths(variables?: VznStaticPathsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<VznStaticPathsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<VznStaticPathsQuery>(VznStaticPathsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'VznStaticPaths', 'query');
    },
    VznById(variables: VznByIdQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<VznByIdQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<VznByIdQuery>(VznByIdDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'VznById', 'query');
    },
