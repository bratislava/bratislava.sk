...
export type ComponentOsItemsAdvancedAccordionDepartment = {
  ...
  id: Scalars['ID'];
  itemsFirstLevel?: Maybe<Array<Maybe<ComponentOsItemsAdvancedAccordionSubItem>>>;
  title?: Maybe<Scalars['String']>;
};


export type ComponentOsItemsAdvancedAccordionDepartmentItemsFirstLevelArgs = {
...
export type ComponentOsItemsAdvancedAccordionSubItem = {
  ...
  itemsInside?: Maybe<Array<Maybe<ComponentOsItemsAdvancedAccordionSubSubItem>>>;
  title?: Maybe<Scalars['String']>;
};


export type ComponentOsItemsAdvancedAccordionSubItemItemsInsideArgs = {
