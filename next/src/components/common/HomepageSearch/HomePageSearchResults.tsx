    ...
    <div className="flex flex-col" data-cy="homepage-search-results">
      {data.hits.map(({ title, link }, index) => (
        <Link
          ...
          key={index}
          passHref
          className="px-4 py-2 base-focus-ring ring-inset hover:bg-background-passive-secondary focus:bg-background-passive-secondary"
          ref={(el) => {
      ...
      <Link
        ...
        passHref
        className="px-4 py-2 font-semibold base-focus-ring ring-inset hover:bg-background-passive-secondary focus:bg-background-passive-secondary"
        ref={(el) => {
