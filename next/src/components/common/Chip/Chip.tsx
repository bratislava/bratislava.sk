...
const Chip = ({ variant = 'large', ...props }: ChipProps) => {
  return (
    <Tag
      {...props}
      className={cn(
        'flex shrink-0 cursor-pointer items-center rounded-lg border-2 outline-hidden hover:bg-grey-200 focus-visible:ring-3 focus-visible:ring-offset-2 selected:border-category-700 selected:bg-category-700 selected:text-grey-0 hover:selected:bg-category-700',
        {
