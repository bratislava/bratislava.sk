  ...
  return (
    ...
    >
      {subpageList.map((subpage, index) => (
        ...
        >
          <div className="text-h3 flex size-12 shrink-0 grow-0 basis-12 items-center justify-center rounded-full bg-category-600 font-semibold text-white sm:size-16 sm:basis-16">
            {index + 1}
          </div>
