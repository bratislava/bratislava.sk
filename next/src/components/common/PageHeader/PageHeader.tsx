      ...
      <div className="mx-auto max-w-(--breakpoint-xl) px-4 lg:px-8">
        <div className="flex flex-col">
          ...
          <div className="flex flex-col gap-y-4 pt-3 pb-6 lg:gap-y-6 lg:pt-6 lg:pb-10">
            ...
            {tag ? (
              <span className="inline-block self-start rounded-sm bg-category-700 px-3 py-1 text-size-p-default font-medium text-content-passive-inverted-primary empty:hidden">
                {tag}
              </span>
            ) : null}
