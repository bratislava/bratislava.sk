...
const OrganizationalStructureAccordionCard = ({
  ...
  return (
    ...
    displayName && jobTitle ? (
      <div
        className={twMerge(
          'flex min-w-66 max-w-88 flex-col rounded-lg border-2 bg-white px-6 py-8',
          className,
        )}
      >
            ...
            {mail && mailUserName && mailOrganization ? (
              <>
                <div className="flex gap-x-4">
                  ...
                  <div className="text-component-small lg:text-default font-semibold">
                ...
                {mailUserName?.length > mailBreakpoint && (
                  <div className="text-component-small lg:text-default hidden font-semibold lg:flex lg:pl-12">
                    @{mailOrganization}
                  </div>
                )}
              </>
