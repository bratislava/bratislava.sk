      ...
      >
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="relative w-full rounded-lg border border-border-active-default px-15 py-5 pr-23 base-focus-ring hover:border-border-active-hover focus:border-border-active-focused"
