...
import { UrbanStudyEntityFragment } from '@/src/services/graphql'
        ...
        <div className="flex max-w-200 flex-col gap-8 lg:gap-10">
          ...
          {detailItems.length > 0 ? (
            <>
              ...
              <div className="flex flex-col gap-4">
                <Typography variant="h2">{t('UrbanStudyPageContent.detailsTitle')}</Typography>
                <div className="flex flex-col gap-4">
          ...
          {filteredLinks.length > 0 ? (
            <>
              <HorizontalDivider />
              <div className="flex flex-col gap-4">
                <Typography variant="h2">{t('UrbanStudyPageContent.linksTitle')}</Typography>
                <ul className="flex flex-col gap-2">
                  {filteredLinks.map((link, index) => (
                    <li key={index}>
                      <MLink variant="underlined" {...getLinkProps(link)} />
                    </li>
                  ))}
                </ul>
              </div>
