...
export async function logAllSectionsByType({
  ...
  console.log(`Searching through ${CONSOLE_BLUE}${environment.strapiUrl}${CONSOLE_WHITE}`)
  console.log(
  ...
  entities.forEach((entity) => {
    const strapiEntityLink = `${environment.strapiUrl}/admin/content-manager/collection-types/api::${entityType}.${entityType}/${entity.documentId}`
  ...
  console.log('\n')
  console.log(
    `${CONSOLE_YELLOW}Finished searching through ${CONSOLE_BLUE}${environment.strapiUrl}${CONSOLE_GREY} (to search other Strapi instances, change your .env.local)`,
  )
  console.log(
