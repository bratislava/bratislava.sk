...
export { default as EuroIcon } from './euro-wrapped.svg'
export { default as PlaneIcon } from './lietadlo-wrapped.svg'
export { default as MapIcon } from './map-wrapped.svg'
export { default as CityServicesIcon } from './mestske-sluzby-wrapped.svg'
export { default as PersonIcon } from './referenti-wrapped.svg'
