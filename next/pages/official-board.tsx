...
import OfficialBoardBackgroundImage from '../components/assets/images/official-board.png';
        ...
        >
          <SectionContainer>
            <div className="min-h-[220px] relative">
              ...
              <h1 className="pt-30 text-md md:text-2xl font-bold whitespace-pre-wrap">
                {boardPage?.title}
              </h1>
            </div>
          </SectionContainer>
