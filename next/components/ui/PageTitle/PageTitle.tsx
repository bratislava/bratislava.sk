...
export const PageTitle = ({ className, title, subtitle, ...rest }: PageTitleProps) => (
  <h1 className={cx(className, 'flex flex-col w-64')} {...rest}>
    ...
    <span className="text-h3-bold sm:text-h1-bold text-primary sm:leading-[62px]">{title}</span>
    <span className="text-h3-bold sm:text-h1-bold text-primary sm:leading-[62px]">{subtitle}</span>
  </h1>
)
