      ...
      >
        ...
        <div className={cx('lg:flex', { hidden: !collapse }, { flex: collapse })}>
          ...
          <Button
            ...
            className="hover:color-white text-p1 h-14 rounded-l-none px-6 font-medium capitalize shadow-none hover:bg-category-600 hover:text-white"
        ...
        <div className={cx('lg:hidden gap-y-4', { 'flex flex-col': !collapse }, { hidden: collapse })}>
          ...
          <Button
            ...
            className="hover:color-white text-base h-11 px-12 font-medium capitalize shadow-none hover:bg-category-600 hover:text-white lg:h-14"
            variant="secondary-dark-text"
            onClick={() => onSubmit(input)}
          >
            {buttonText}
