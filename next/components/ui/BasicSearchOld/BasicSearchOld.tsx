      ...
      >
        ...
        <div className={cx('lg:flex', { hidden: !collapse }, { flex: collapse })}>
          ...
          <Button
            ...
            className="hover:color-white text-20 h-14 rounded-l-none px-6 font-medium capitalize shadow-none hover:bg-category-600 hover:text-white"
        ...
        >
          <input
            id="name"
            type="text"
            className="text-16 h-12 w-full rounded-lg border-2 pl-6 font-medium text-font outline-none lg:h-14"
            placeholder={placeholder}
            onChange={(e) => setInput(e.target.value)}
            value={input}
          />
          <Button
            ...
            className="hover:color-white text-16 h-11 px-12 font-medium capitalize shadow-none hover:bg-category-600 hover:text-white lg:h-14"
            variant="secondary-dark-text"
            onClick={() => onSubmit(input)}
          >
            {buttonText}
