    ...
    <div className={cx('flex flex-col w-full', className)}>
      ...
      <div className="hidden pb-6 lg:flex">
        ...
        <Button
          ...
          className={cx(
            'h-14 rounded-l-none text-20-medium px-6 shadow-none hover:bg-primary hover:text-white hover:color-white'
          )}
      ...
      <div className="flex pb-6 lg:hidden">
        ...
        <Button
          icon={<SearchIcon />}
          hoverIcon={<SearchIcon />}
          className="hover:color-white text-20-medium h-14 rounded-l-none pr-6 shadow-none hover:bg-primary hover:text-white"
          variant="secondary-dark-text"
          onClick={handleSearch}
        />
      </div>
