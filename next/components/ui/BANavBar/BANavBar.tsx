...
const LanguageSelect = ({
  ...
  return (
    <div className="relative flex w-12 items-center" ref={ref} onClick={handleClick}>
      ...
      {isSelectClicked && isComponentVisible && (
        <div className="absolute top-6 -left-3 z-20 mt-1 flex h-auto w-11 flex-col items-center justify-center lg:left-0">
