...
import BookWithChildColored from './icons/icon-book-with-child-colored-new.svg'
...
import CarWithMapColored from './icons/icon-car-with-map-colored-new.svg'
import CarWithMap from './icons/icon-car-with-map.svg'
import Car from './icons/icon-car.svg'
import CastleColored from './icons/icon-castle-colored-new.svg'
...
import HandHeartColored from './icons/icon-hand-heart-colored-new.svg'
...
import HouseWithTreeColored from './icons/icon-house-with-tree-colored-new.svg'
