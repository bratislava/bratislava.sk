...
<Meta
  title="components/molecules/AdvancedAccordion"
      ...
      firstItem: {
        ...
        departments: [
            ...
            subdepartments: [
              {
                departments: [
                  ...
                  {
                    title:
                      'Sprostredkovateľský orgán - Integrovaný regionálny operačný program',
                  },
          ...
          },
          {
            ...
            subdepartments: [
              { departments: [{ title: 'Poradcovia primátora' }] },
            ],
            departmentPhone: '+421 *** *** ***',
            departmentCards: [
              {
        ...
        departments: [
          ...
          },
          {
            ...
            subdepartments: [
              {
                groupHeading:
                  'Priamo riadené oddelenia zástupcom riaditeľa magistrátu',
                departments: [
                  {
              ...
              {
                groupHeading:
                  'Priamo riadené oddelenia zástupkyňou riaditeľa magistrátu',
                departments: [
                  {
