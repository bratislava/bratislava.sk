...
export const WeddingForm = () => {
  ...
  return (
    <div className="z-10 mx-auto w-10/12">
      ...
      <p className="text-center text-p1 font-medium">
      ...
      <form>
          ...
          <div className="grow">
            ...
            >
              ...
              >
                <Input
                  ...
                  className="h-12.5 w-full text-button-1 text-font focus:outline-none"
                  // hasError={!!errors?.email}
            ...
            >
              <TextArea
                id="notes"
                name="notes"
                className="pt-5 pb-3.5 text-button-1"
                rows={11}
                // hasError={!!errors?.email}
        ...
        <div className="flex justify-center">
          <Button className="mt-8 h-12 w-3/12 text-button-1 font-medium lg:mt-10">
