...
const TooltipShowCase: FC<TooltipShowCaseProps> = ({}: TooltipShowCaseProps) => {
  return (
    <Wrapper title="Tooltip" direction="column">
      <p>WARNING: props absolute, top, bottom, left and right are not showed here but in field header - they are same as setting classNames to absolute, bottom, top, left and right </p>
      <Stack direction="row">
