  ...
  return (
    <Wrapper title="Upload" direction="column">
      <Stack direction="column">
        ...
        <div className="w-96">
          <UploadedFile fileName="something_wrong.jp" errorMessage="Error message"
                        onRemove={() => console.log('REMOVE')}/>
        </div>
      </Stack>
      <Stack>
        <Upload type="button" ref={ref} value={files1}
                onChange={(newValue) => {
                  setFiles1(newValue)
      ...
      <Stack direction="column">
        <Upload type="button" sizeLimit={5} supportedFormats={['.jpg', '.png', '.pdf']} value={files2}
                onChange={(newValue) => setFiles2(newValue)}/>
        <Upload type="button" sizeLimit={5} value={files3} onChange={(newValue) => setFiles3(newValue)}/>
        <Upload type="button" supportedFormats={['.jpg', '.png', '.pdf']} value={files4}
      ...
      <Stack direction="column">
        <Upload type="dragAndDrop" sizeLimit={5} supportedFormats={['.jpg', '.png', '.pdf']} value={files6}
                onChange={(newValue) => setFiles6(newValue)}/>
        <Upload type="dragAndDrop" sizeLimit={5} value={files7}
                onChange={(newValue) => setFiles7(newValue)} />
        <Upload type="dragAndDrop" supportedFormats={['.jpg', '.png', '.pdf']} value={files8}
