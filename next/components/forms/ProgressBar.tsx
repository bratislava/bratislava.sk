...
const ProgressBar = ({ type = 'default', value = 0, minValue = 0, maxValue = 100, className }:ProgressBarBase) => {
  ...
  const progressBarStyleContainer = cx('flex flex-row items-center p-0 gap-4 w-[500px] h-6', className, {
  })
  return (
    <div {...progressBarProps} className={progressBarStyleContainer}>
      <div className={cx('flex flex-column items-center w-[440px] h-2 bg-form-input-default rounded-full')}>
