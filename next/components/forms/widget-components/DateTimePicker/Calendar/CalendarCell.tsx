  ...
  return (
    <div {...cellProps}>
      <div
        ...
        ref={ref}
        className={cx(
          'text-p2 flex h-8 w-8 items-center justify-center font-medium focus:rounded-lg focus:bg-gray-700 focus:text-white focus-visible:outline-none xs:h-10 xs:w-10',
          {
