...
const DateSegmentComponent = ({ segment, state }: DateSegmentBase) => {
  ...
  return (
    <div
      {...segmentProps}
      ref={ref}
      className="text-default hover:bg-gray-100 focus:bg-gray-100 focus:outline-none"
    >
      <span
...
const DateField = ({
  ...
  const dateFieldStyle = cx('flex rounded-lg border-2 bg-white px-3 py-1.5 sm:px-4 sm:py-2.5', {
