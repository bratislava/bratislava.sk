...
const TextAreaField = (
  ...
  const style = cx(
    'w-full px-4 py-2.5 w-80 h-[196px] border-2 border-form-input-default text-20 leading-8 rounded-lg caret-form-input-pressed focus:outline-none focus:border-form-input-pressed resize-none',
    className,
    {
      // hover
