...
const TextAreaField = (
  ...
  const style = cx(
    'w-full px-4 py-2.5 w-320 h-196 border-2 border-form-input-default text-lbl-1 leading-8 rounded-lg caret-form-input-pressed focus:outline-none focus:border-form-input-pressed resize-none',
    className,
    {
      // hover
