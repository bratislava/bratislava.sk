...
`
  ...
  const switcher = (): ReactNode => {
    ...
    return (
      <div className="flex flex-col w-full max-w-screen-2lg m-auto mt-8 px-4 lg:px-0">
  ...
  return (
    <div className="flex flex-col">
      ...
      {isOn === 'default' && (
        <div className="w-full max-w-screen-2lg m-auto">
          <ul className="my-2 lg:my-8 px-4 sm:px-6 2lg:px-0">
            {cards.map((card, i) => (
