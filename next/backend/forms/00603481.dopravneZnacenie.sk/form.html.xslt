...
<xsl:stylesheet version="1.0"
    ...
    <xsl:if test="$values/*[local-name() = 'PoschodieACisloBytu']">
      <xsl:call-template name="base_labeled_field">
        <xsl:with-param name="text">
          <xsl:text>Poschodie a číslo bytu</xsl:text>
        </xsl:with-param>
  ...
  <xsl:template name="base_default_css">
    <link
            href="https://www.slovensko.sk/static/eForm/Designer/2.0.1.12/Styles/jquery-ui.css"
            rel="stylesheet" type="text/css" />
    <link
            href="https://www.slovensko.sk/static/eForm/Designer/2.0.1.12/Styles/base.css"
            rel="stylesheet" type="text/css" />
    <link
            href="https://www.slovensko.sk/static/eForm/Designer/2.0.1.12/Styles/ego.css"
            rel="stylesheet" type="text/css" />
    <link
            href="https://www.slovensko.sk/static/eForm/Designer/2.0.1.12/Styles/p_upvs.css"
            rel="stylesheet" type="text/css" />
    <link
